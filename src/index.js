...
bot.start(async (ctx) => {
    ...
    await ctx.reply(
        "Sale Maps — цифровые наборы точек (.kmz) для Organic Maps / MAPS.ME по городам.\nПосле оплаты файл приходит в этот чат.\n\nПоддержка: silvershtain@mail.ru (ответ в течение 24 часов).\n\nНажми кнопку «🗺 Открыть витрину» ниже 🔻 — выбирай город и получишь файл в этот чат.",
        withWebAppKeyboard({
            parse_mode: "Markdown",
